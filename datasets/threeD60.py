...
class ThreeD60(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # rgb_name, rot_ang = recover_filename(self.rgb_depth_list[idx][0])
        # rgb_path = os.path.join(self.root_dir, rgb_name)
        ...
        if self.is_training and self.yaw_rotation_augmentation:
            # random rotation
            random_val = random.randint(0, self.w // 16)

            roll_idx = random_val * 4 + (self.w * rot_ang) // 360
