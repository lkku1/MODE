...
class Evaluator(object):
    ...
    def compute_eval_metrics(self, gt_depth, pred_depth, mask):
        ...
        abs_, abs_rel, sq_rel, rms, rms_log, log10, a1, a2, a3 = \
            compute_depth_metrics(gt_depth, pred_depth, mask)

        # path = '/media/lyb/CE7258D87258C73D/linux/github/'
        # f = open(path + 'a1.txt', 'a')
        # f.write(str(rms))
        # f.write('\n')
        # f.close()
        # f = open(path + 'a2.txt', 'a')
        # f.write('\n')
        # f.write(str(a2))
        # f.close()
        # f = open(path + 'a3.txt', 'a')
        #
        # f.write('\n')
        # f.write(str(a3))
        # f.close()
        # f = open(path + 'rmse.txt', 'a')
        # f.write('\n')
        # f.write(str(rms))
        # f.close()
        # f = open(path + 'rmselog.txt', 'a')
        # f.write('\n')
        # f.write(str(rms_log))
        # f.close()
        # f = open(path + 'mae.txt', 'a')
        # f.write('\n')
        # f.write(str(abs_))
        # f.close()
        # f = open(path + 'mre.txt', 'a')
        # f.write('\n')
        # f.write(str(abs_rel))
        # f.close()
